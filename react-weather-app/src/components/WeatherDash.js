          ...
          <div className="row card0">
            <div className="card1 col-lg-8 col-md-7">
              ...
              <div className="text-center">
                <img className="image mt-5" src="https://i.imgur.com/M8VyA2h.png" alt="Weather icon" />
              </div>
              <div className="row px-3 mt-3 mb-3">
                ...
                <div className="d-flex flex-column text-center">
                  ...
                  <small>{props.forecastData.list[0].weather[0].main}</small>
                </div>
              </div>
            </div>
            <div className="card2 col-lg-4 col-md-5">
                ...
                <div className="mr-5">
                  <ul>
                    {props.items.map((item, index) => (
                      <li key={index} onClick={props.itemSubmitHandler}>{item}</li>
                    ))}
                  </ul>
                </div>
              ) : (
              ...
              <p>Weather Details</p>
              <div className="row px-3">
                <p className="light-text">{props.forecastData.list[0].weather[0].description}</p>
                <p className="ml-auto">12%</p>
              </div>
              <div className="row px-3">
                <p className="light-text">Humidity</p>
                <p className="ml-auto">{props.forecastData.list[0].main.humidity}%</p>
              </div>
              <div className="row px-3">
                <p className="light-text">Wind</p>
                <p className="ml-auto">{props.forecastData.list[0].wind.speed} speed km/h</p>
              </div>
              <div className="row px-3">
